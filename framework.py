...
# This is the framework for our version of Tetris.

class BaseGame():
    def __init__(self):

        # defines which blocks have which colors
        self.block_colors = {
            'clevelandZ': 'red',
            'rhodeIslandZ': 'green',
            'blueRicky': 'blue',
        ...
        # List of blocks and their possible positions (i.e. number of rotations)
        self.block_list = {
            'orangeRicky': [['..x',
                             'xxx'],
                            ['x.',
        ...
        # Some extras, most of them are related to the board.
        self.blank_color = '.'
        ...
        # Not needed for implementation. (If so, that's fine aswell)
        self.box_size = 20
    ...
    def test_quit_game(self):
        ...
        for event in pygame.event.get(QUIT):
            pygame.quit()
            sys.exit()
        # get all KEYUP events (all keypresses)
    ...
    # draws the game board into the game window
